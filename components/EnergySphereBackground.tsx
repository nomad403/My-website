  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // Correction aspect ratio + centrage CSS combinés
    ...
    function onMouseMove(event: MouseEvent) {
      ...
      // Compensation du transform: translate(-50%, -50%)
      const x = event.clientX - rect.left + window.innerWidth / 2 - rect.width / 2
      const y = event.clientY - rect.top + window.innerHeight / 2 - rect.height / 2
