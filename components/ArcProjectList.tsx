      ...
      <AnimatePresence>
        {visibleProjects.map((project, i) => {
          ...
          const angle = startAngle + i * angleStep
                     ...
                     // Position sur l'arc autour de la sphère - point de référence = FIN du texte (extrémité droite)
           const arcX = sphereCenter.x + Math.cos(angle) * arcRadius - 200 // Position de l'arc
           const arcY = sphereCenter.y + Math.sin(angle) * arcRadius
           
           // Position du texte : la FIN du texte (extrémité droite) doit être sur l'arc
           const x = arcX // La FIN du texte est sur l'arc
          ...
          return (
            <motion.div
              ...
              initial={{ opacity: 0, scale: 0.8 }}
                 ...
                 opacity,
                 scale,
                 x: x, // Position exacte de l'extrémité droite sur l'arc
            ...
            >
              {project.name}
               ...
               {/* Repère de position du texte - extrémité droite */}
               <div
