...
export default function SphereAlignedArcMenu({
  ...
  useEffect(() => {
    function calculateSphereMetrics() {
      ...
      // Ajustement visuel : décaler légèrement vers le haut pour compenser l'effet de glow
      const visualCenterY = centerY - 30
      ...
      setSphereCenter({ x: centerX, y: visualCenterY })
