    ...
    function calculateSphereMetrics() {
      ...
      const actualSphereRadius = shaderBaseRadius * minSide
       ...
       const centerY = viewportHeight * 0.5 - 100 // Centre visuel de la sphère
             ...
             // Rayon de l'arc : plus proche de la sphère pour suivre sa courbure
       const padding = 40
   ...
   const leftOffset = -200
     ...
     >
       ...
       <div
         ...
         style={{
           left: sphereCenter.x + Math.cos(Math.PI) * arcRadius + leftOffset - 4,
          ...
          return (
            <motion.div
              ...
              initial={{ opacity: 0, scale: 0.8 }}
                 ...
                 opacity,
                 scale,
                 x: x, // Position exacte sur l'arc (point de référence à droite)
