      ...
      <AnimatePresence>
        {visibleProjects.map((project, i) => {
          ...
          const angle = startAngle + i * angleStep
                     ...
                     // Position sur l'arc autour de la sphère - point de référence = extrémité droite du texte
           ...
           // Position du texte : l'extrémité droite doit être sur l'arc
           const x = arcX // L'extrémité droite du texte est sur l'arc
