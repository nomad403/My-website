...
export default function SphereAlignedArcMenu({
  ...
  useEffect(() => {
    function calculateSphereMetrics() {
      ...
      const listOffset = 200 // Offset augmenté pour éloigner la liste de la sphère
  ...
  // Angle pour positionner la liste BIEN À GAUCHE de la sphère (200°)
  const centerAngle = Math.PI + (20 * Math.PI) / 180 // 180° + 20° = 200°
