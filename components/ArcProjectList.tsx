     ...
     >
      ...
      <AnimatePresence>
        {visibleProjects.map((project, i) => {
          ...
          // Position horizontale FIXE à gauche de la sphère
          const x = sphereCenter.x - sphereRadius - 80 // 80px d'offset à gauche du bord de la sphère
          // Courbure verticale sur l'arc
          ...
          return (
            <motion.div
              ...
              animate={{
                opacity,
                scale,
                x: x, // Position horizontale FIXE à gauche de la sphère
