          ...
          <motion.div
            ...
            transition={{
              ...
              `}
                 ...
                 transform: "translateX(0%)", // DÉBUT du texte (T de TurnUpSphere) aligné sur l'arc
            ...
            {item.project.name}
             ...
             {item.isSelected && (
               <motion.div
                 initial={{ scale: 0 }}
                 animate={{ scale: 1 }}
                 className="absolute -left-3 top-1/2 transform -translate-y-1/2 w-2 h-2 bg-white rounded-full shadow-lg"
               />
             )}
          </motion.div>
        ))}
