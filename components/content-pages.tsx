        ...
        return (
          <div className="relative w-full h-screen overflow-hidden">
            ...
            />
                                     ...
                                     {/* Carrousel cylindrique 3D en arrière-plan */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-auto z-5 overflow-visible">
            ...
            <div className="absolute right-8 top-1/2 transform -translate-y-1/2 pointer-events-auto z-30">
