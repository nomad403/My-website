      ...
      case "projects":
        return (
          <div className="relative w-full h-full overflow-hidden">
            ...
            {/* Contenu principal du projet sélectionné - Responsive sans scroll */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="max-w-5xl w-full px-4 relative z-10 pointer-events-auto">
                <div className="grid grid-cols-12 gap-4 sm:gap-6 lg:gap-8 h-[70vh] max-h-[600px] min-h-[400px]">
                  {/* Zone centrale : affichage de l'image */}
                  <div className="col-span-12 md:col-span-6 flex items-center justify-center">
                    <div className="w-full h-full max-h-[40vh] md:max-h-[50vh] flex items-center justify-center">
                      <AnimatePresence mode="wait" initial={false}>
                        ...
                        >
                          <img
                            ...
                            className="w-full h-full object-contain max-h-[35vh] md:max-h-[45vh]"
                            onLoad={(e) => {
                  ...
                  <div className="col-span-12 md:col-span-6 flex flex-col justify-center md:pl-4 overflow-hidden">
                    <div className="mb-4 sm:mb-6">
                      <div className="font-kode text-base sm:text-lg text-blue-700">{projectList[selected].name}</div>
                      <div className="glass-container mt-2" style={{ minWidth: 'fit-content', maxWidth: '100%' }}>
                        <LiquidGlassBackground />
                        <div className="glass-filter"></div>
                        <div className="glass-overlay"></div>
                        <div className="glass-specular"></div>
                        <div className="glass-content font-mono text-xs stack-accent px-3 py-1 rounded shadow-inner inline-block" style={{padding: '0.4rem 1rem'}}>
                          {projectList[selected].stack.map((tech, i) => (
                            <span key={tech}>{i > 0 && ' | '}<span className="">{tech}</span></span>
                                         ...
                                         <div className="font-jetbrains text-sm sm:text-base text-[#111] leading-relaxed project-description flex-1 max-h-[25vh] md:max-h-[30vh] pr-2 overflow-hidden">
                      {selected === 0 && (
                        <p>
                          <ShuffleText text={
