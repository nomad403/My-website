      ...
      case "projects":
        return (
          <div className="relative w-full h-screen overflow-hidden">
            ...
            {/* Image centrée comme la sphère */}
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="w-full max-w-md h-[40vh] max-h-[350px] flex items-center justify-center pointer-events-auto">
                <AnimatePresence mode="wait" initial={false}>
                  ...
                  >
                    ...
                    />
                         ...
                         {/* Description à droite - plus d'espace disponible */}
             <div className="absolute right-12 top-1/2 transform -translate-y-1/2 w-[22rem] max-w-[40vw] pointer-events-auto">
              <div className="flex flex-col justify-center">
                                 <div className="mb-3">
                   <div className="font-kode text-sm sm:text-base lg:text-lg text-blue-700">{projectList[selected].name}</div>
                                       <div className="glass-container mt-2" style={{ minWidth: 'fit-content', maxWidth: '85%' }}>
                     <LiquidGlassBackground />
                     <div className="glass-filter"></div>
                     <div className="glass-overlay"></div>
                     <div className="glass-specular"></div>
                     <div className="glass-content font-mono text-xs stack-accent px-2 py-1 rounded shadow-inner inline-block" style={{padding: '0.3rem 0.6rem'}}>
                 ...
                 <div className="font-jetbrains text-xs sm:text-sm leading-relaxed project-description max-h-[45vh] overflow-y-auto pr-2">
                  {selected === 0 && (
                    <p>
                      <ShuffleText text={
