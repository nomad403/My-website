...
export default function ContentPages({ currentPage, onBack }: ContentPagesProps) {
        ...
        case "skills":
         ...
         return (
           <div className="relative w-full h-full overflow-hidden">
             ...
             <div className="max-w-5xl mx-auto mt-16 px-4 relative z-10 h-[calc(100vh-4rem)]">
                             <div className="grid grid-cols-12 gap-8 h-full max-h-[calc(100vh-8rem)]">
                 {/* Zone centrale : affichage de l'image */}
                 <div className="col-span-6 flex items-center justify-center relative">
                   <div className="w-full h-[50vh] max-h-[400px] flex items-center justify-center">
                 ...
                 <div className="col-span-6 flex flex-col justify-center items-start pl-4 overflow-hidden">
                 <div className="mb-4">
                    ...
                    <div className="glass-content font-mono text-xs stack-accent px-3 py-1 rounded shadow-inner inline-block" style={{padding: '0.5rem 1.2rem'}}>
                      {projectList[selected].stack.map((tech, i) => (
                        <span key={tech}>{i > 0 && ' | '}<span className="">{tech}</span></span>
                                 ...
                                 <div className="font-jetbrains text-base text-[#111] leading-relaxed project-description max-h-[30vh] overflow-hidden">
                  {selected === 0 && (
                    <p>
                      <ShuffleText text={
  ...
  const slideDirection = selected > prevSelected ? 1 : -1;
     ...
     return (
     <div className="relative w-full min-h-screen z-20 overflow-hidden">
