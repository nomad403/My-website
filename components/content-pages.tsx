                  ...
                  <AnimatePresence mode="wait" initial={false}>
                    ...
                    >
                      ...
                      />
                                            ...
                                            {/* Description à droite de la sphère */}
               <div className="absolute right-4 top-1/2 transform -translate-y-1/2 w-72 max-w-[calc(50vw-2rem)] pointer-events-auto">
                 <div className="flex flex-col justify-center">
                   <div className="mb-3">
                     <div className="font-kode text-base sm:text-lg text-blue-700 text-right">{projectList[selected].name}</div>
                     <div className="glass-container mt-2 flex justify-end">
                       <LiquidGlassBackground />
                       <div className="glass-filter"></div>
                       <div className="glass-overlay"></div>
                       <div className="glass-specular"></div>
                       <div className="glass-content font-mono text-xs stack-accent px-3 py-1 rounded shadow-inner" style={{padding: '0.4rem 0.8rem'}}>
                   ...
                   <div className="font-jetbrains text-xs sm:text-sm text-[#111] leading-relaxed project-description text-right max-h-[30vh] overflow-y-auto">
                     {selected === 0 && (
                       <p>
                         <ShuffleText text={
