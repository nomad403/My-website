...
import SphereAlignedArcMenu from "./ArcProjectList"
  ...
  const getPageContent = () => {
    switch (currentPage) {
      ...
      case "projects":
        ...
        return (
          <div className="max-w-7xl mx-auto mt-32 px-4 overlay-hidden">
            
            <div className="grid grid-cols-12 gap-8 min-h-[600px]">
              {/* Colonne gauche : liste des projets en arc de cercle */}
              <div className="col-span-3 border-r border-gray-200 pr-4 relative z-20 pointer-events-auto">
                <div className="font-kode text-lg mb-8 text-left pl-0">PROJECTS</div>
                <SphereAlignedArcMenu
              ...
              <div className="col-span-4 flex flex-col justify-center h-full items-start pl-16">
                <div className="mb-6">
