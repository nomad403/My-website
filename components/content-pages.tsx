            ...
            <div className="relative w-full h-screen overflow-hidden">
             ...
             />
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
               ...
               <div className="absolute right-8 top-1/2 transform -translate-y-1/2 w-80 max-w-sm pointer-events-auto">
                                 <div className="flex flex-col justify-center overflow-hidden text-right">
                   <div className="mb-4">
