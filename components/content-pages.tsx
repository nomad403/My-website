        ...
        return (
          <div className="relative w-full h-screen overflow-hidden">
            ...
            />
                         ...
                         {/* Image à droite */}
             <div className="absolute right-12 top-1/2 transform -translate-y-1/2 pointer-events-auto">
               <div className="w-[22rem] max-w-[40vw] h-[50vh] max-h-[400px] flex items-center justify-center">
