              ...
              <div className="flex flex-col justify-center">
                <div className="mb-4">
                  ...
                  <div className="glass-container mt-2" style={{ minWidth: 'fit-content', maxWidth: '100%' }}>
                    ...
                    <div className="glass-content font-mono text-xs stack-accent px-3 py-1 rounded shadow-inner inline-block" style={{padding: '0.4rem 0.8rem'}}>
                ...
                <div className="font-jetbrains text-sm text-[#111] leading-relaxed project-description max-h-[40vh] overflow-hidden">
                  {selected === 0 && (
                    <p>
                      <ShuffleText text={
