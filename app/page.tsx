...
export default function HomePage() {
  ...
  const handlePageChange = (newPage: string, direction?: string) => {
    ...
    if (newPage === "projects" && currentPage === "home") {
      ...
      setSphereScale(4) // Agrandit la sphère pour un effet horizon plus immersif
      setSphereTranslateY(600) // Descend beaucoup plus la sphère pour voir sa partie supérieure en bas
    }
